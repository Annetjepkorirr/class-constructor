...
class Car {
    ...
    toogleAvailability(){ !this.isAvailable
    }
}
...
// a rental involving the car you created. Finally, calculate the rental duration using the
//calculateRentalDuration method.
...
quiz.submitAnswer('Nat')
quiz.submitAnswer('Female')
